...
generator_hash="$({ git ls-tree -r --full-tree HEAD -- cmd/generate_data internal/dataconv internal/azurlanelua tools/ci data/static-helpers .github/workflows/validate-and-update.yml go.mod go.sum; } | sha256sum | cut -d' ' -f1)"
previous_sha=""
